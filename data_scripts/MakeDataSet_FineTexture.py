...
OutputDir = "/home/wenbo-bao/bwb/GANVideo_new_fineTexture300/"
...
VideoDir = "/media/wenbo-bao/TOSHIBA EXT/GANVideo" #"G:/GANVideo/"
...
for file in file_list:
    ...
    for j in range(1, group_num, 1): # read 300 frames from each video , that is about 10 second
        ...
        if ret1 == False or ret2 == False or ret3 == False or ret4 == False or ret5 == False:
            break
        ...
        for sample_x, sample_y in zip(x_list, y_list):
            ...
            avg_motion = int((motion12 + motion23 + motion34+ motion45)/4.0/0.5)
            ...
            if  motion12 < THRESHOLD_MOTION or  motion12 >= THRESHOLD_MOTION_HIGH or\
                ...
                motion45 < THRESHOLD_MOTION or  motion45 >= THRESHOLD_MOTION_HIGH:
            ...
            dif = numpy.mean(numpy.abs((texture_1/ 255.) - (texture_5/ 255.)))

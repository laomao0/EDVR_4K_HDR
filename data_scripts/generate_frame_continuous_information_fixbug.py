        ...
        for folder_index, folder_ in enumerate(folder_lists):
            ...
            for i in range(Len_div_Num):
                ...
                for indx, file in enumerate(file_list_div):
                    ...
                    difference = calculate_difference(current_img_gray, next_img_gray)
                ...
                Avg_difference = difference_total / (len(file_list_div) - 1)
                ...
                for indx, file in enumerate(file_list_div):
                    ...
                    difference = calculate_difference(current_img_gray, last_img_gray)

                    print (folder_index, ' ', file, ' ', psnr, ' ', difference)
                    ...
                    if difference < Threhold * Avg_difference:
                        para = para + 1

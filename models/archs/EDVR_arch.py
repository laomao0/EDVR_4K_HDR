...
try:
    from models.archs.non_local.non_local_pytorch_0_4_1_to_1_1_0.lib.non_local_dot_product_separate_non_local import NONLocalBlock3D_SE 
except ImportError:
...
class EDVR(nn.Module):
    def __init__(self, nf=64, nframes=5, groups=8, front_RBs=5, back_RBs=10, center=None,
                 predeblur=False, HR_in=False, w_TSA=True, channel_att=False, non_local=False):
        ...
        #### non local net
        if non_local == True:
            self.non_local_net = NONLocalBlock3D_SE(nf,inter_channels=nf, sub_sample=False, bn_layer=False)

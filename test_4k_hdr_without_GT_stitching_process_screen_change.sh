...
python test_4k_hdr_without_GT_stitching_process_screen_change.py \
        ...
        --output_path /DATA7_DB7/data/4khdr/data/Results/train_EDVR_L_Preload_30000_nobug_221_20000_G_test_540p \

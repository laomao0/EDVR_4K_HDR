        ...
        if opt['name'].lower() in ['vid4', 'reds4']:
            ...
            for subfolder_LQ, subfolder_GT in zip(subfolders_LQ, subfolders_GT):
                ...
                if self.cache_data:
                    ...
                    self.imgs_LQ[subfolder_name] = util.read_img_seq_display(img_paths_LQ, '{}_LQ'.format(subfolder_name))
                    self.imgs_GT[subfolder_name] = util.read_img_seq_display(img_paths_GT, '{}_GT'.format(subfolder_name))

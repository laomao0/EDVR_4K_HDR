...
def main():
    ...
    for subfolder in subfolder_l:
        ...
        for img_idx, img_path in enumerate(img_path_l):
            ...
            select_idx, log1, log2, nota = data_util.index_generation_process_screen_change_withlog(input_subfolder, frame_notation, img_idx, max_idx, N_in, padding=padding)

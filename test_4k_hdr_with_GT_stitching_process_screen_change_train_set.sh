...
python test_4k_hdr_with_GT_stitching_process_screen_change_train_set.py \
        --input_path /DATA7_DB7/data/4khdr/data/Dataset/train_540p \
        --gt_path /DATA7_DB7/data/4khdr/data/Dataset/train_4k \
        --screen_notation  /DATA7_DB7/data/4khdr/data/Dataset/4khdr_frame_notation.json \
        --output_path /DATA7_DB7/data/4khdr/data/Results/train_EDVR_L_Preload_30000_nobug_latest_G_train_set \
        --model_path /DATA7_DB7/data/4khdr/codes/experiments/train_EDVR_L_Preload_30000_nobug_3/models/latest_G.pth \

...
python test_4k_hdr_without_GT_stitching_process_screen_change_bug_fix.py \
        --input_path /DATA7_DB7/data/4khdr/data/Dataset/test_540p \
        --screen_notation  /DATA7_DB7/data/4khdr/data/Dataset/test_4khdr_frame_notation.json \
        --output_path /DATA7_DB7/data/4khdr/data/Results/train_EDVR_L_Preload_30000_nobug_nf192_rb80_ssim_parall \
        --model_path /DATA7_DB7/data/4khdr/codes/experiments/train_EDVR_L_Preload_30000_nobug_nf192_rb80_ssim_parall/models/latest_G.pth \
